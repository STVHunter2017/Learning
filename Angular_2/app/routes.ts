...
export const appRoutes: Routes = [
    ...
    {path: 'events/new', component: CreateEvent, canDeactivate:['canDeactivateCreateEvent']}, //Ensure this is processed before the :id route as this will match with :id as well
